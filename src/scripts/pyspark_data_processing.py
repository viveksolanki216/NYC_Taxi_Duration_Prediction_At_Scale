...
if __name__ == "__main__":
    ...
    # ------------------------------------------------------------------------------------------------------------------
    if mode == "train":
        # Since we have tens of thousands of categories in pickup_drop_loc and more than half of them are rare,
        # we will convert the rare categories to 'Other' category.
        threshold = 20
        common_categories_list = []
        for cat_f in cat_features:
        # Find common categories and store them in a list
